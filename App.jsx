            ...
            return(
              <div style={{background:IT.teal,borderRadius:14,padding:"14px 12px",marginBottom:8}}>
                <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10}}>
                  {acts.map((ac,ai)=>(
                    <div key={ai} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:0}}>
                      <div style={{width:"100%",aspectRatio:"1",borderRadius:12,overflow:"hidden",background:"rgba(255,255,255,0.2)",marginBottom:6,boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}}>
                        {ac.photo
                          ? <img src={ac.photo} alt={ac.name||ac.title} style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}}/>
                          : <div style={{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(255,255,255,0.15)"}}>
                              <Icon.Ticket size={28} color="rgba(255,255,255,0.6)"/>
                            </div>
                        }
                      </div>
                      <div style={{fontSize:11,fontWeight:600,color:"#fff",textAlign:"center",lineHeight:1.3,textShadow:"0 1px 3px rgba(0,0,0,0.3)"}}>{ac.name||ac.title}</div>
                    </div>
                  ))}
                </div>
              </div>
